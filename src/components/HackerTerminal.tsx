...
const SEQUENCE = [
    ...
    { text: "  > Daily work involves building efficient APIs (PHP/Node.js/SQL) & frontend (JavaScript).", delay: 200, type: "system", color: "text-slate-300" },
    ...
    { text: "  [>] Implementing complex backend functions and REST APIs using PHP, Node.js & SQL.", delay: 200, type: "system", color: "text-slate-300" },
